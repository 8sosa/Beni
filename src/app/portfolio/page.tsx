            ...
            return (
              ...
              >
                ...
                <div className="space-y-4 flex flex-col justify-end aspect-[1/1] p-20 sm:p-4 sm:justify-start sm:aspect-[16/9]">
                  ...
                  <h2 className="text-4xl font-bold text-black pb-20">
                    {project.title}
                  </h2>
                  <p className="text-gray-700">{project.description}</p>
                  <Link href={`/portfolio/${slug}`} className="justify-self-end mt-4 text-sm font-semibold text-gray-700 hover:text-black transition-colors">
                      View Project &rarr;
                  </Link>
                </div>
              </div>
